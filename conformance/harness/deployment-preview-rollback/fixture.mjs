...
export function deploymentPlan(standardVersion, options = {}) {
  ...
  return {
    ...
    activation: { expectedCurrentDeploymentId: options.expectedCurrentDeploymentId ?? "deployment-old", servingPolicy: "all-configured-targets-ready", drainSeconds: 30, emergency: options.emergency ?? false },
  };
}
